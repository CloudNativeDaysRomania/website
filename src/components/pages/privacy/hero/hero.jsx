...
const Hero = () => (
  <section className="safe-paddings pb-10 pt-24 lg:pt-[4.5rem] md:pb-4 md:pt-16 sm:py-8">
    <div className="container mt-4 text-left text-primary-1 sm:px-7">
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Types of Data Collected</h3>
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Personal Data</h4>
      <p>
      ...
      <br />
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Usage Data</h4>
      ...
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Use of Your Personal Data</h3>
      ...
      <br />
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Retention of Your Personal Data</h3>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Transfer of Your Personal Data</h3>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Delete Your Personal Data</h3>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Disclosure of Your Personal Data</h3>
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Business Transactions</h4>
      <p>
      ...
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Law enforcement</h4>
      <p>
      ...
      <br />
      <h4 className="text-xl leading-normal text-primary-1">Other legal requirements</h4>
      <p>
      ...
      <br />
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Security of Your Personal Data</h3>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Children's Privacy</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Changes to this Privacy Policy</h2>
      <p>
