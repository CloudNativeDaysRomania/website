...
const Hero = () => (
  <section className="safe-paddings pb-10 pt-24 lg:pt-[4.5rem] md:pb-4 md:pt-16 sm:py-8">
    <div className="container mt-4 text-left text-primary-1 sm:px-7">
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Interpretation and Definitions</h2>
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Interpretation</h3>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Definitions</h3>
      ...
      <ul className="ml-8 mt-4 list-disc">
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to ASOCIATIA CLOUD NATIVE,
            Str. Râmnicu Vâlcea, nr. 27, bloc 20C, Bucuresti, 031805, Romania.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cloud Native Days Romania, accessible from{' '}
            <a href="https://cloudnativedays.ro/" rel="external nofollow noopener noreferrer" target="_blank">
              https://cloudnativedays.ro/
            </a>
          </p>
        </li>
        <li>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Acknowledgment</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Links to Other Websites</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Termination</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Limitation of Liability</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Governing Law</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Disputes Resolution</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">For European Union (EU) Users</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">United States Legal Compliance</h2>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Severability and Waiver</h2>
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Severability</h3>
      <p>
      ...
      <br />
      <h3 className="text-2xl leading-normal text-primary-1">Waiver</h3>
      <p>
      ...
      <br />
      <h2 className="text-4xl leading-normal text-primary-1">Translation Interpretation</h2>
      <p>
