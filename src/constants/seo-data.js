export default {
  ...
  team: {
    ...
    description: 'Experience the power of community at the Cloud Native Days in Romania!',
  },
  archive: {
    title: 'Cloud Native Days Romania 2024 - Event Highlights',
    description:
  ...
  terms: {
    title: 'Cloud Native Days Romania 2024 - Terms of Use',
    description:
      'By using the Cloud Native Days Romania website, you agree to our terms of use. Learn more about the conditions that govern your use of our website.',
  },
  podcast: {
  ...
  static: ({ title }) => ({
    title: `${title} — Cloud Native Days`,
  }),

  page404: {
    title: 'Page Not Found — Cloud Native Days',
