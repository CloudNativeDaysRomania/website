...
const SPEAKERS = [
  ...
  },
  {
    ...
    content:
      'Radu Vunvulea is a technology enthusiast working as VP of Cloud for Endava.' +
      'He has a vast experience in different technologies and industries. Most of his time is spent working with the cloud, helping companies to innovate and finding solutions to their business problems.' +
    ...
    twitterUrl: 'https://twitter.com/RaduVunvulea',
    linkedInUrl: 'https://linkedin.com/in/raduvunvulea/',
    githubUrl: '',
    communityUrl: '',
    instagramUrl: '',
    websiteUrl: 'https://vunvulearadu.blogspot.com',
    time: '14:00',
    title: 'Workshop: FinOps in Practice',
    duration: '120 min',
  },
];
